...
<svelte:head>
	...
	<link
		href="https://fonts.googleapis.com/css2?family=Inter:wght@200..900&family=Nunito:wght@200..1000&display=swap"
		rel="stylesheet"
	/>
	<style>
		:root {
			...
			--color-yellow-2: #ffe68c;
			--color-bee: #f1bc00;
			--color-link: #b58d00;

			--color-input-background: var(--color-gray-1);
